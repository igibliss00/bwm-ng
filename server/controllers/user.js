...
exports.auth = function(req, res) {
    ...
    if (!password || !email) {
        return res.status(422).send({errors: [{title: 'Data is missing!', detail:  "Provide email and password!"}]});
    }
...
exports.register = function(req, res) {
   ...
   User.findOne({email}, function(err, existingUser){
       ...
       if (existingUser) {
           return res.status(422).send({errors: [{title: 'Invalid email!', detail: 'This email already exists'}]});
       }
